                ...
                <div className="login">
                    <form onSubmit={verifyLogin}>
                        <h1>API Key</h1>
                            <div className="input-div">
                                ...
                                <g id="lock">
                                <g>
                                <rect fill="none" height="10" rx="2" ry="2" stroke="#aeb1b0" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" width="16" x="4" y="11"/>
                                <path d="M16.5,11V8h0c0-2.8-.5-5-4.5-5S7.5,5.2,7.5,8h0v3" fill="none" stroke="#aeb1b0" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>
                                </g>
                                </g>
                                </g>
                                </svg>
                                ...
                                {showPassword ? 
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M22 12.0002C20.2531 15.5764 15.8775 19 11.9998 19C8.12201 19 3.74646 15.5764 2 11.9998" stroke="#aeb1b0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M22 12.0002C20.2531 8.42398 15.8782 5 12.0005 5C8.1227 5 3.74646 8.42314 2 11.9998" stroke="#aeb1b0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M15 12C15 13.6569 13.6569 15 12 15C10.3431 15 9 13.6569 9 12C9 10.3431 10.3431 9 12 9C13.6569 9 15 10.3431 15 12Z" stroke="#aeb1b0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg> :
                    ...
                    <div className="login-buttons">
                            ...
                            <button onClick={completeKey}>
                                <svg width="21px" height="21px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
